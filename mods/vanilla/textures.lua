      ...
      layers = {
        {
          ...
          steps = {
            { op = "fbm", seed = 2, out = "g" },
            {
              op = "ramp",
              input = "g",
              stops = { { 0.0, 0.26, 0.46, 0.18 }, { 1.0, 0.45, 0.7, 0.28 } },
            },
          },
        },
        {
          period = 3,
          steps = {
            { op = "voronoi", cells = 4, seed = 14, out = "v" },
    ...
    },
    {
      ...
      layers = {
        ...
        },
        {
          ...
          steps = {
            { op = "gradient", out = "g" },
            { op = "fbm", cells = 6, octaves = 3, seed = 4, out = "n" },
            { op = "warp", input = "g", by = "n", amount = 0.06, out = "gw" },
            { op = "threshold", input = "gw", threshold = 0.78, softness = 0.02, out = "band" },
            {
              op = "ramp",
              input = "n",
      ...
      layers = {
        {
          ...
          steps = {
            ...
            { op = "threshold", input = "st", threshold = 0.12, softness = 0.08, out = "body" },
