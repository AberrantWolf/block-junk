...
- **Styling (egui 0.33)**: `Rounding` is now `CornerRadius` (u8 fields, e.g.
  ...
  build as `egui::Frame::default().fill(..).stroke(..).corner_radius(..)
  .inner_margin(Margin::same(8))`. Two-skin pattern used in this repo
